...
const getData = async url => {
  try {
    ...
    console.log("\nGET response from".green, url.blue, "\n", data);
    return data;
  } catch (error) {
    console.log("GET ERROR:".red, error.response.data);
  }
};
...
const postForm = async (url, file) => {
  try {
    ...
    console.log("\nPOST response from".green, url.blue, "\n", data);
    return data;
  } catch (error) {
    console.log("POST ERROR:".red, error.response.data);
  }
};
